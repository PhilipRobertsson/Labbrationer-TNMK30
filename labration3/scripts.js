...
function liveClock(){
	...
	var temp = document.getElementById("numberOfPosts").value;
	if(temp != "" && temp > 0){
		numbPosts = document.getElementById("numberOfPosts").value;
		console.log(numbPosts);
		var hiddenInput = document.getElementById("hiddenNumberOfPosts");
		hiddenInput.value = numbPosts;
	}
}
